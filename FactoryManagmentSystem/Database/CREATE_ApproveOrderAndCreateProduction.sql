-- =============================================
-- CREATE: sp_ApproveOrderAndCreateProduction
-- This is the procedure the C# code expects
-- =============================================

USE GarmentsFactoryDB;
GO

PRINT '🔧 Creating sp_ApproveOrderAndCreateProduction...';
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            -- Log usage if StockUsage table exists
        ...
        -- Production order created (no link back to approval - column doesn't exist)
...
PRINT '✅ sp_ApproveOrderAndCreateProduction created successfully';
GO

-- Verify it exists
SELECT name, create_date FROM sys.procedures WHERE name = 'sp_ApproveOrderAndCreateProduction';
GO

PRINT '';
PRINT '✅ All procedures ready for Order Approval system!';
