...
public partial class SalesManagerDashboard : Window
{
    ...
    {
        InitializeComponent();
        WelcomeText.Text = $"Sales Manager: {UserSession.FullName}";
    ...
    private void UpdateMainContent(string contentType)
    {
        ...
        switch (contentType)
        {
            case "Dashboard":
                ...
                PageSubtitle.Text = "Overview of sales operations";
                DashboardContent.Visibility = Visibility.Visible;
                break;
                
            case "Products":
                PageTitle.Text = "Add New Products";
                PageSubtitle.Text = "Manage product catalog";
                ShowProductManagement();
                break;
                
            case "SalesOrders":
                PageTitle.Text = "Sales Orders";
                PageSubtitle.Text = "Manage sales orders";
                ShowSalesOrdersManagement();
                break;
                
            case "Deals":
                PageTitle.Text = "Deals";
                PageSubtitle.Text = "Manage deals with retailers";
                ShowDealsManagement();
                break;
